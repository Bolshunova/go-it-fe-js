...
function Cashier(name, productDatabase) {
  ...
  this.customerMoney = 0;
    ...
    this.countTotalPrice = function (order) {
      ...
      const entriesProducts = Object.entries(productDatabase); 
      ...
      for (let entryOrder of entriesOrder) {
        for (let entryProducts of entriesProducts) {
          if (entryOrder[0] === entryProducts[0]) {
            result = (entryOrder[1] * entryProducts[1]);
